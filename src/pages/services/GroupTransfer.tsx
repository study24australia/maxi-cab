      ...
      <section className="bg-gradient-to-r from-orange-500 to-orange-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl font-bold mb-6">Group Transfer Service</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="text-center p-6 bg-gray-50 rounded-xl">
              ...
              <p className="text-gray-600">We handle all the logistics to keep your group together and on schedule.</p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl">
              ...
              <p className="text-gray-600">Spacious maxi cabs and minibuses to accommodate groups of all sizes.</p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-xl">
              ...
              <p className="text-gray-600">Dependable transportation that ensures your group arrives safely and on time.</p>
            </div>
          </div>
